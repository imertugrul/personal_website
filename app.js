...
(function () {
  ...
  var dicts = {
    de: {
      ...
      hero_badge: 'Informatiklehrer · KI-Berater · Stuttgart',
      hero_h1: 'Informatik. Über den Unterricht hinaus.',
      hero_p: 'Ich begleite Schülerinnen und Schüler in internationalen Informatikprogrammen — IB, AP und IGCSE — und berate Schulen bei der Integration Künstlicher Intelligenz, der Lehrplanentwicklung und der Fortbildung von Lehrkräften. Diese Arbeit basiert auf fünfzehn Jahren Informatikunterricht an internationalen Schulen — am Robert College in Istanbul und an der International School of Stuttgart.',
      ...
      about_p1: 'Meine Laufbahn als Informatiklehrer begann 2009 am Robert College in Istanbul — einer der renommiertesten Schulen der Türkei. In den folgenden acht Jahren baute ich Informatikprogramme auf, betreute Robotik-Teams und entwickelte ein Gespür dafür, wie abstrakte Konzepte auch für Jugendliche greifbar werden, die sich mit Informatik zunächst wenig anfangen konnten. 2017 wechselte ich an die International School of Stuttgart, wo ich seitdem IB DP Computer Science, AP Computer Science und MYP unterrichte — und die Robotik- und KI-AG von Grund auf aufgebaut habe.',
      about_p2: 'Alle Tätigkeiten, die ich außerhalb des Unterrichts ausübe, knüpfen an eine Frage an, die mich seit fünfzehn Jahren im Unterricht beschäftigt: Wie lernen und verändern sich Schülerinnen und Schüler — und wie Institutionen? Lehrplanentwicklung, die Einführung Künstlicher Intelligenz und die Begleitung von Robotik-Teams sind unterschiedliche Antworten auf dieselbe Frage.',
      cred1: 'IB DP CS (SL & HL)', cred2: 'Google Certified Trainer', cred3: 'AP CS A', cred4: 'Digital Citizenship Educator', cred5: '15+ Jahre an internationalen Schulen',
      why_label: '// warum mit mir', why_h2: 'Verwurzelt in fünfzehn Jahren Informatikunterricht an internationalen Schulen.',
      ...
      why1_body: 'Ich unterrichte, was ich berate. Wenn ich eine Schule zur KI-Integration oder zum Informatik-Lehrplan berate, beruht das auf fünfzehn Jahren gelebter Unterrichtspraxis an internationalen Schulen — am Robert College in Istanbul und an der International School of Stuttgart.',
      ...
      course1_b1: 'Neuer 2027er Lehrplan — fünf Kerneinheiten', course1_b2: 'Java und Python — beide Sprachen, beide Paper',
      ...
      course2_b3: 'AP-Prüfungsstrategie: Multiple Choice und FRQ', course2_b4: 'Das Ziel ist College-Credit — darauf arbeiten wir hin',
      ...
      exp1_org: 'International School of Stuttgart', exp1_loc: 'Stuttgart, Deutschland', exp1_period: '2017 – Heute',
      ...
      exp2_org: 'Robert College Istanbul', exp2_loc: 'Istanbul, Türkei', exp2_period: '2009 – 2017',
    ...
    tr: {
      ...
      hero_badge: 'Bilgisayar Bilimi Eğitmeni · Yapay Zekâ Danışmanı · Stuttgart',
      hero_h1: 'Bilgisayar Bilimi Eğitimi. Sınıfın Ötesinde.',
      hero_p: 'IB, AP ve IGCSE gibi uluslararası Bilgisayar Bilimi programlarında öğrenim gören öğrencilerle ve yapay zekâ entegrasyonu, müfredat geliştirme ve öğretmen eğitimi konularında okullarla çalışıyorum. Bu çalışmaların temelini, Robert Kolej İstanbul ve International School of Stuttgart\'ta edindiğim on beş yılı aşkın uluslararası eğitim deneyimi oluşturuyor.',
      ...
      about_p1: 'Bilgisayar Bilimi öğretmenliğine 2009 yılında, Türkiye\'nin en köklü liselerinden biri olan Robert Kolej\'de başladım. Sekiz yıl boyunca Bilgisayar Bilimi müfredatları geliştirdim, robotik kulüpler kurdum ve proje tabanlı öğrenmeyi derslerin merkezine taşıdım. 2017\'de Almanya\'ya taşınarak International School of Stuttgart\'ta IB DP Bilgisayar Bilimi, AP Bilgisayar Bilimi ve MYP derslerini vermeye başladım; aynı zamanda sıfırdan bir Robotik ve Yapay Zekâ Kulübü kurdum.',
      about_p2: 'Sınıf dışındaki çalışmalarımın tamamı, on beş yıldır yanıt aradığım aynı sorudan besleniyor: Öğrenciler ve kurumlar gerçekte nasıl öğrenir, nasıl değişir? Müfredat geliştirme, yapay zekâ danışmanlığı ve robotik koçluğu; bu sorunun farklı bağlamlardaki karşılıkları.',
      cred1: 'IB DP Bilgisayar Bilimi (SL & HL)', cred2: 'Google Sertifikalı Eğitmen', cred3: 'AP Bilgisayar Bilimi A', cred4: 'Dijital Vatandaşlık Eğitmeni', cred5: 'Uluslararası okullarda 15+ yıl',
      ...
      why1_body: 'Danışmanlık yaptığım konuları bizzat öğretiyorum. Bir okula yapay zekâ entegrasyonu ya da Bilgisayar Bilimi müfredatı konusunda tavsiye verirken, dayandığım şey on beş yıldır uluslararası sınıflarda yaptığım çalışmanın ta kendisi — Robert Kolej İstanbul ve International School of Stuttgart\'taki deneyimim.',
      why2_title: 'Teknik Derinlik',
      why2_body: 'Önerdiğim şeyleri bizzat hayata geçiriyorum. Özel bir yapay zekâ ajanı, okul yönetimi için otomatize edilmiş iş akışları ya da bir robotik müfredatı olsun; stratejiden çalışan yazılıma kadar her aşamayı üçüncü bir tarafa ihtiyaç duymadan tamamlayabiliyorum.',
      ...
      course1_b1: 'Yeni 2027 müfredatı — beş temel ünite', course1_b2: 'Java ve Python — her iki dil, her iki paper',
      ...
      course2_b3: 'AP sınav stratejisi: çoktan seçmeli ve FRQ', course2_b4: 'Hedef üniversite kredisi — buna doğru birlikte ilerliyoruz',
      ...
      con_intro: 'Pek çok okul yapay zekâyı öncelikli gündem maddesi hâline getirdi. Asıl soru, bunun pratikte neye benzeyeceği: hangi araçlar, hangi süreçler, hangi eğitim — ve tüm bunların sınıfta gerçek bir fark yaratacak şekilde nasıl hayata geçirileceği.',
      conA_title: 'Yapay Zekâ Entegrasyon Danışmanlığı',
      conA_desc: 'Strateji, uygulamalı eğitim ve müfredat entegrasyonu — okulunuzun gerçek işleyişi üzerine kurulu.',
      conA_b1: 'Ders ve sınıf düzeyinde müfredat entegrasyonu',
      conA_b2: 'Araçlarınıza, derslerinize ve ekibinize göre şekillenen öğretmen eğitimi',
      conA_b3: 'Tarafsız teknoloji tavsiyesi — bağımsız ve komisyonsuz',
      conA_who: 'Okul yöneticileri ve müfredat ekipleri',
      conB_title: 'Özel Yapay Zekâ Araçları ve Ajanlar',
      conB_desc: 'Okulunuzun idari ve pedagojik süreçlerine göre özel olarak geliştirilen araçlar.',
      conB_b1: 'Gerçek zaman kazandıran idari otomasyon',
      conB_b2: 'Öğrencilere yönelik araçlar ve asistanlar',
      conB_b3: 'Öğretmenlerin idari yükünü azaltan araçlar',
      conB_who: 'Okullar ve eğitim teknolojisi girişimleri',
      ...
      exp1_org: 'International School of Stuttgart', exp1_loc: 'Stuttgart, Almanya', exp1_period: '2017 – Günümüz',
      exp1_r1: 'IB DP Bilgisayar Bilimi (SL & HL)', exp1_r2: 'AP Bilgisayar Bilimi A', exp1_r3: 'MYP',
      exp1_r4: 'Robotik ve Yapay Zekâ Kulübü — Kurucu & Koç',
      exp2_org: 'Robert Kolej İstanbul', exp2_loc: 'İstanbul, Türkiye', exp2_period: '2009 – 2017',
      exp2_r1: 'Bilgisayar Bilimi', exp2_r2: 'AP Bilgisayar Bilimi', exp2_r3: 'Robotik Kulübü — Kurucu & Koç',
